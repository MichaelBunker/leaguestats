 ...
 * @ORM\Entity
 * @ORM\Table(name="player_game_stats_15")
 */
class PlayerGameStats15
{
    /**
     * Player Game Stats primary key.
     *
     * @ORM\Column(type="integer", name="player_game_stat_15_id")
     * @ORM\Id
     * @ORM\GeneratedValue(strategy="AUTO")
     */
    private $playerGameStat15Id;

    /**
     * @return mixed
     */
    public function getPlayerGameStat15Id()
    {
        return $this->playerGameStat15Id;
    }

    /**
     * @param mixed $playerGameStat15Id
     */
    public function setPlayerGameStat15Id($playerGameStat15Id)
    {
        $this->playerGameStat15Id = $playerGameStat15Id;
    }
