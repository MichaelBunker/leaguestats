 ...
 * @ORM\Entity
 * @ORM\Table(name="player_game_stats_20")
 */
class PlayerGameStats20
{
    /**
     * Player Game Stats primary key.
     *
     * @ORM\Column(type="integer", name="player_game_stat_20_id")
     * @ORM\Id
     * @ORM\GeneratedValue(strategy="AUTO")
     */
    private $playerGameStat20Id;

    /**
     * @return mixed
     */
    public function getPlayerGameStat20Id()
    {
        return $this->playerGameStat20Id;
    }

    /**
     * @param mixed $playerGameStat20Id
     */
    public function setPlayerGameStat20Id($playerGameStat20Id)
    {
        $this->playerGameStat20Id = $playerGameStat20Id;
    }
